...
const BottomSheetModalComponent = /*#__PURE__*/(0, _react.forwardRef)((props, ref) => {
  ...
  const key = (0, _react.useMemo)(() => name || `bottom-sheet-modal-${(0, _nonSecure.nanoid)()}`, [name]);
  ...
  const adjustIndex = (0, _react.useCallback)((_index, internal = true) => dismissOnPanDown ? internal ? _index - 1 : _index + 1 : _index, [dismissOnPanDown]);
  ...
  const handleSnapTo = (0, _react.useCallback)((_index, ...args) => {
    ...
    (_bottomSheetRef$curre = bottomSheetRef.current) === null || _bottomSheetRef$curre === void 0 ? void 0 : _bottomSheetRef$curre.snapTo(adjustIndex(_index, false), ...args);
  }, [adjustIndex]);
  const handleExpand = (0, _react.useCallback)((...args) => {
    ...
    (_bottomSheetRef$curre2 = bottomSheetRef.current) === null || _bottomSheetRef$curre2 === void 0 ? void 0 : _bottomSheetRef$curre2.expand(...args);
  }, []);
  const handleCollapse = (0, _react.useCallback)((...args) => {
    ...
    if (dismissOnPanDown) {
      ...
      (_bottomSheetRef$curre3 = bottomSheetRef.current) === null || _bottomSheetRef$curre3 === void 0 ? void 0 : _bottomSheetRef$curre3.snapTo(1, ...args);
    } else {
  ...
  const handleDismiss = (0, _react.useCallback)((...args) => {
    ...
    if (minimized.current || currentIndexRef.current === 0 && dismissOnPanDown) {
      unmount();
      return;
    }
    ...
    (_bottomSheetRef$curre6 = bottomSheetRef.current) === null || _bottomSheetRef$curre6 === void 0 ? void 0 : _bottomSheetRef$curre6.close(...args);
