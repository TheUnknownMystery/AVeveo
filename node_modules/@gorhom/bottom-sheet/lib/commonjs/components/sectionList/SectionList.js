...
const BottomSheetSectionListComponent = /*#__PURE__*/(0, _react.forwardRef)((props, ref) => {
  // props
  const {
  ...
  } = (0, _hooks.useScrollableInternal)(BottomSheetSectionListName);
  const {
  ...
  }, /*#__PURE__*/_react.default.createElement(AnimatedSectionList, _extends({}, rest, {
    // @ts-ignore
    ref: scrollableRef,
