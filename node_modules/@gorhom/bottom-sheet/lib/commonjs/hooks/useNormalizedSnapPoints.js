...
const useNormalizedSnapPoints = (snapPoints, topInset, containerHeight = 0, handleHeight = 0) => (0, _react.useMemo)(() => {
  const normalizedSnapPoints = (0, _utilities.normalizeSnapPoints)(snapPoints, containerHeight, topInset);
