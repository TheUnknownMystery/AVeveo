...
const usePropsValidator = ({
  ...
  (0, _react.useMemo)(() => {
    ...
    (0, _invariant.default)(typeof index === 'number' ? index >= -1 && index <= snapPoints.length - 1 : true, `'index' was provided but out of the provided snap points range! expected value to be between -1, ${snapPoints.length - 1}`); // topInset
