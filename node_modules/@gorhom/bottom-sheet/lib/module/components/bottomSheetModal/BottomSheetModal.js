...
import { DEFAULT_STACK_BEHAVIOR, DEFAULT_DISMISS_ON_PAN_DOWN } from './constants';
const BottomSheetModalComponent = /*#__PURE__*/forwardRef((props, ref) => {
  ...
  const adjustIndex = useCallback((_index, internal = true) => dismissOnPanDown ? internal ? _index - 1 : _index + 1 : _index, [dismissOnPanDown]);
  ...
  const handleSnapTo = useCallback((_index, ...args) => {
