export { default } from './components/bottomSheet'; // scrollables
...
export { default as BottomSheetView } from './components/view'; // helpers
...
} = BottomSheetTouchable; // text input

export { default as BottomSheetTextInput } from './components/bottomSheetTextInput'; // backdrop

export { default as BottomSheetBackdrop } from './components/bottomSheetBackdrop'; // modal

export { default as BottomSheetModal } from './components/bottomSheetModal';
export { default as BottomSheetModalProvider } from './components/bottomSheetModalProvider'; // hooks
...
export { useBottomSheetTimingConfigs } from './hooks/useBottomSheetTimingConfigs'; // components types
